...
class Mmux < Formula
  ...
  url "https://github.com/marvinvr/mmux/archive/refs/tags/v0.9.1.tar.gz"
  sha256 "ed771f145269f46938273b7dc9208e6efb0224239256f0902d9555569075a991"
  head "https://github.com/marvinvr/mmux.git", branch: "main"

  on_macos do
    on_arm do
      url "https://github.com/marvinvr/mmux/releases/download/v0.9.1/mmux-aarch64-apple-darwin.tar.gz"
      sha256 "66808b7d660e59f0350ef5ddca401d54eec661d847bd19539e01f523c580b19c"
    end
    on_intel do
