...
class Mmux < Formula
  ...
  url "https://github.com/marvinvr/mmux/archive/refs/tags/v0.6.2.tar.gz"
  sha256 "5249e6f013f6cca87086087414735c7c833df452843bb3131a9455ac1912eec4"
  head "https://github.com/marvinvr/mmux.git", branch: "main"

  on_macos do
    on_arm do
      url "https://github.com/marvinvr/mmux/releases/download/v0.6.2/mmux-aarch64-apple-darwin.tar.gz"
      sha256 "32370f40b47e3f7a93faa203b6d2ec724172d2d66848314b778ae2ecc23c38c6"
    end
    on_intel do
      url "https://github.com/marvinvr/mmux/releases/download/v0.6.2/mmux-x86_64-apple-darwin.tar.gz"
      sha256 "1a68724aa0d0b92d3dd459a5ffffbb24d405bf12072172fc9c116f7875d4305d"
    end
  end

  on_linux do
    on_intel do
      url "https://github.com/marvinvr/mmux/releases/download/v0.6.2/mmux-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "22be736e042af18550b3250b2e76a53c472b638c18e82986ca6281a51842a601"
    end
    on_arm do
