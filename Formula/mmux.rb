...
class Mmux < Formula
  ...
  url "https://github.com/marvinvr/mmux/archive/refs/tags/v0.7.3.tar.gz"
  sha256 "0eb41e7f4bcda559845c97f0ef6b09e03ba2af6986fc7f83ddefa21b010b26e3"
  head "https://github.com/marvinvr/mmux.git", branch: "main"

  on_macos do
    on_arm do
      url "https://github.com/marvinvr/mmux/releases/download/v0.7.3/mmux-aarch64-apple-darwin.tar.gz"
      sha256 "6707c9462abab434279760939e167c295a6178c6c520536824b39ee105beb907"
    end
    on_intel do
      url "https://github.com/marvinvr/mmux/releases/download/v0.7.3/mmux-x86_64-apple-darwin.tar.gz"
      sha256 "01acc96d860b47f8bd0bd9503c302ec18d71c4ced37a0380ca9965a4f86ab857"
    end
  end

  on_linux do
    on_intel do
      url "https://github.com/marvinvr/mmux/releases/download/v0.7.3/mmux-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "6739b99de07e6c17bd65c5deed69ee1996b42601491b979648bf9fe63086e120"
    end
    on_arm do
